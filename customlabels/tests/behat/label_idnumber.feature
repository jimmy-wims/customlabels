...
Feature: set customlabels idnumber
  In order to set customlabels idnumber
  As a teacher
  I should create customlabels activity and set an ID number

  @javascript
  Scenario: customlabels ID number input box should be shown.
    ...
    And the field "ID number" matches value "C1CUSTOMLABEL1"
