...
/**
 * Search area for mod_customlabels activities.
 *
...
namespace mod_customlabels\search;
...
class activity extends \core_search\base_activity {
    ...
    /**
     * Overwritten as customlabelss are displayed in-course.
     *
     * @param \core_search\document $doc
     * @return \moodle_url
     */
    public function get_doc_url(\core_search\document $doc) {
        // Get correct URL to section that contains customlabels, from course format.
        ...
        // Add the ID of the customlabels to the section URL.
        $url->set_anchor('module-' . $cminfo->id);
        return $url;
    }

    /**
     * Overwritten as customlabelss are displayed in-course. Link to the course.
     *
     * @param \core_search\document $doc
     * @return \moodle_url
     */
